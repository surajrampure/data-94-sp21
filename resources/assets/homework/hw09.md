...
In this final homework of the semester, you will create a public-facing website with text and visualizations that you will create on your own, using a dataset that you choose on your own. You'll be able to share this website link with anyone you want, and you will submit the assignment by posting your website link on Ed ([in this thread](https://edstem.org/us/courses/3251/discussion/391281)) for the rest of the class to see.
...
1. [Finding a dataset and creating a visualization of interest (1-2 hours)](#part1).
...
4. [Submission (~15 minutes)](#part4).
5. [(Optional) Adding More Content](#part5).
6. [Grading](#grading)

Throughout this tutorial, we will show you screenshots from an example website that we built. The links to this website and the corresponding repo (explained later on) are below. **You cannot use this dataset.**
...
1. Find a dataset you want to work with in the CSV format and download it to your computer. Slides 13 and 14 of [Lecture 33](https://docs.google.com/presentation/d/1wA1taEpdonSa-WTuDriNwK6vWOMHewj14nejHZBlFHc/edit#slide=id.gd34f647e78_0_0) list several potential sources.
  - Try your best not to overlap datasets with others in the class, though if this happens by coincidence that's fine. Don't use a dataset we've already used this semester in this class.
...
Great! Now you have the information you need to put on a website. The hard part is done.
...
- Under the hood, GitHub Pages will use a library called [Jekyll](https://jekyllrb.com) to convert your `README.md` to the standard HTML file format so that your website is formatted correctly and nicely.
...
- Give the file a new heading (using `#`) that relates to your visualization and write your name on the second line.
...
- This is the bare minimum required, but you can add other text/placeholders to your site too. See [here](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) for how to add other elements to Markdown documents (including images and videos).
- To space things out vertically, put `<br>` on a new line on its own.
...
7. After committing in the previous stage, refresh your website until it loads. If you're happy with the result, congrats! All of the ugly code you copied from your notebook has been converted into your original interactive visualization. At this point, feel free to tweak things. One suggestion is to change the `width` and `height` of your image in your notebook before exporting. (You can repeat the previous step as many times as you want.) As long as you have these essentials, you can add whatever else you want to your website – images, more visualizations, etc. (See the bonus step for fun.)
    <div align="center">
...
At this point, you're ready to submit. There is an optional "Part 5" shown below that shows you how you can add additional components (like videos or Instagram posts) to your site. You're free to submit first and then work on the optional parts, or vice versa. You also are not obligated to look at the optional part at all (but it's cool).
...
Many websites make it surprisingly easy to embed their content into your website. Here, we'll give you a few examples of such sites and give you code snippets that you can place in your `README.md`. Essentially these all work the same – you tell the website you want to embed their content (a tweet, a video, a song, an instagram post) into your website, they give you a piece of code that does it for you, and you copy that code into your website where you want it. That's it!
...
If there are other sites you want to embed content from, just Google "<name of site> embed" and you'll likely find a way to copy the necessary code from the site into your website.
...
Have fun with it, and don't hesitate to post any questions on Ed!
